			...
			elseif KnowHeroSpell(hero,H55_SpellsL4[rnd1]) == nil then
				if contains(H55_LightSpells,H55_SpellsL4[rnd1]) then
					if HasHeroSkill(hero,SKILL_LIGHT_MAGIC) then
						...
						if H55_IsThisAIPlayer(player) ~= 1 then sleep(4) ShowFlyingSign({"/Text/Game/Scripts/Banks/Givespell.txt";name=H55_SpellsTextL4[rnd1]},hero,player,7) end;
						Play3DSoundForPlayers(GetPlayerFilter(player), H55_SndSpell,x,y,z);
						teached = 1;
					end;
			...
			elseif KnowHeroSpell(hero,H55_SpellsL3[rnd2]) == nil then
				if contains(H55_LightSpells,H55_SpellsL3[rnd2]) then
					if HasHeroSkill(hero,SKILL_LIGHT_MAGIC) then
						...
						if H55_IsThisAIPlayer(player) ~= 1 then sleep(4) ShowFlyingSign({"/Text/Game/Scripts/Banks/Givespell.txt";name=H55_SpellsTextL3[rnd2]},hero,player,7) end;
						Play3DSoundForPlayers(GetPlayerFilter(player), H55_SndSpell,x,y,z);	
						teached = 1;
					end;
		...
		if contains(H55_Barbarians,hero) ~= nil then
			...
			if teached == 0 then
				...
				elseif KnowHeroSpell(hero,H55_SpellsL2[rnd4]) == nil then
					...
					if H55_IsThisAIPlayer(player) ~= 1 then sleep(4) ShowFlyingSign({"/Text/Game/Scripts/Banks/Givespell.txt";name=H55_SpellsTextL2[rnd4]},hero,player,7) end;
					Play3DSoundForPlayers(GetPlayerFilter(player), H55_SndSpell,x,y,z);	
					teached = 1;			
				elseif KnowHeroSpell(hero,H55_SpellsL1[rnd1]) == nil then
					TeachHeroSpell(hero,H55_SpellsL1[rnd1]);
					if H55_IsThisAIPlayer(player) ~= 1 then sleep(4) ShowFlyingSign({"/Text/Game/Scripts/Banks/Givespell.txt";name=H55_SpellsTextL1[rnd1]},hero,player,7) end;
					Play3DSoundForPlayers(GetPlayerFilter(player), H55_SndSpell,x,y,z);	
					teached = 1;
